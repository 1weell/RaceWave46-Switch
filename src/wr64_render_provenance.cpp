...
#ifdef WR64_SWITCH
extern "C" void wr64_switch_trace(const char*);
#endif
...
#ifdef WR64_ENABLE_RT64
#ifdef WR64_SWITCH
    wr64_switch_trace("[game-start] waiting for graphics prewarm");
#endif
...
#ifdef WR64_SWITCH
    wr64_switch_trace("[game-start] graphics prewarm finished");
#endif
#endif
}
