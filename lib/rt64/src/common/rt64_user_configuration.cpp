...
#ifdef __SWITCH__
        // The Switch baseline is the native N64 render size. WindowIntegerScale
        // can become 3x at a 720p swapchain and overwhelms the handheld GPU.
...
#ifdef __SWITCH__
        // The Switch port defaults to interpolated 60 Hz presentation. The
        // original 20 Hz cadence remains available as an explicit choice in
        // rt64.json, but it should not be the first-run experience.
        refreshRate = RefreshRate::Manual;
